...
class Ant:
    ...
    def choose_next_customer(self, pheromone_matrix, alpha, beta):
        """Chooses the next customer to visit based on pheromone and heuristic information."""
        unvisited = []
    ...
    def move_to(self, customer_id):
        """Moves the ant to the given customer and updates its state."""
    ...
    def construct_solution(self, pheromone_matrix, alpha, beta):
        """Constructs a solution by visiting customers."""
        self.reset()
        vehicle_count = 0;
...
class PheromoneMatrix:
    ...
    def update_pheromone(self, solutions, instance, evaporation_rate, q):
        """Updates the pheromone matrix based on the solutions."""
        self.matrix *= (1 - evaporation_rate)
...
def ant_colony_optimization(instance, num_ants, max_iterations, alpha, beta, rho, q):
    """Implements the Ant Colony Optimization algorithm for CVRP."""
    ...
    for iteration in range(max_iterations):
        ...
        for _ in range(num_ants):
            ant = Ant(instance)
            solution = ant.construct_solution(pheromone_matrix.matrix, alpha, beta)
            solutions.append(solution)

        pheromone_matrix.update_pheromone(solutions, instance, rho, q)
...
best_solution, best_distance = ant_colony_optimization(instance, num_ants=10, max_iterations=100, alpha=1, beta=2, rho=0.5, q=100)
