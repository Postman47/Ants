...
class PheromoneMatrix:
    ...
    def update_pheromone(self, solutions, instance, evaporation_rate, q):
        """Updates the pheromone matrix based on the solutions (Ant System specific)."""
...
def ant_system(instance, num_ants, max_iterations, alpha, beta, rho, q):
    """Implements the Ant System algorithm for CVRP."""
...
best_solution, best_distance = ant_system(instance, num_ants=10, max_iterations=100, alpha=1, beta=2, rho=0.5, q=100)
